...
public class BizFileController {
    ...
    @SaCheckPermission("/biz/file/uploadDynamicReturnId")
    @PostMapping("/biz/file/uploadDynamicReturnId")
    ...
    @SaCheckPermission("/biz/file/uploadDynamicReturnUrl")
    @PostMapping("/biz/file/uploadDynamicReturnUrl")
    ...
    @SaCheckPermission("/biz/file/uploadLocalReturnId")
    ...
    @SaCheckPermission("/biz/file/uploadLocalReturnUrl")
    ...
    @PostMapping("/biz/file/uploadAliyunReturnId")
    ...
    @PostMapping("/biz/file/uploadAliyunReturnUrl")
    ...
    @PostMapping("/biz/file/uploadTencentReturnId")
    ...
    @PostMapping("/biz/file/uploadTencentReturnUrl")
    ...
    @PostMapping("/biz/file/uploadMinioReturnId")
    ...
    @PostMapping("/biz/file/uploadMinioReturnUrl")
    ...
    @ApiOperation("获取文件列表")
    @SaCheckPermission("/biz/file/list")
    @GetMapping("/biz/file/list")
    ...
    @ApiOperation("下载文件")
    @CommonLog("下载文件")
    @SaCheckPermission("/biz/file/download")
    @GetMapping(value = "/biz/file/download", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
    ...
    @PostMapping(value = "/biz/file/delete")
